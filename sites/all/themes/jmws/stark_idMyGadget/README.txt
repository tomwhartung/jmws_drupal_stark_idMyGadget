...
ABOUT STARK_IDMYGADGET
----------------------
This is the drupal default theme stark integrated with IdMyGadget Device Detection.

The goal is to simply make that work, and add device-specific phone nav and
hamburger nav abilities, and not necessarily make a theme that looks pretty
